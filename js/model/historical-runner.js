  ...
  if (!window) {
    ...
    const returnsProvider = {
      getYearReturns(yearIndex) {
        ...
        const equityAllocation = Number(mappedInputs.equityAllocation || 0);
        const bondAllocation = Number(mappedInputs.bondAllocation || 0);
        const cashAllocation = Number(mappedInputs.cashAllocation || 0);
